---
title: 'Chat SDK for JavaScript'
---

<span style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
  <img src="https://img.shields.io/badge/platform-JAVASCRIPT-orange.svg" noZoom alt="Platform" />
  <img src="https://img.shields.io/badge/language-TYPESCRIPT-orange.svg" noZoom alt="Languages" />
  <img
    src="https://img.shields.io/npm/v/ermis-chat-js-sdk.svg?style=popout&colorB=red"
    noZoom
    alt="npm"
    style={{ display: 'inline-block', cursor: 'pointer' }}
    onClick={() => window.open('https://www.npmjs.com/package/ermis-chat-js-sdk', '_blank')}
  />
</span>
...
await chatClient.connectUser(
  {
    api_key: API_KEY,
    id: user_id,
    name: user_name,      // optional, default_value: user_id
    avatar: user_avatar   // optional
  },
  token,
  external_auth,
);
